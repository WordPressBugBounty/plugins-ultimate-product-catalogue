...
class ewdupcpViewCatalog extends ewdupcpView {
	...
	public $excluded_layouts;
	public $starting_layout;
	public $products_per_page;
	public $current_page;
	public $sidebar;
	public $overview_mode;
	public $omit_fields;
	public $ajax_url;
	public $category;
	public $subcategory;
	...
	// Stores the max price for product filtering
	public $filtering_max_price;

	// Stores the min price for product filtering
	public $filtering_min_price;

	// Any layouts that should not be shown
	public $excluded_views;

	// Stores which products should be used for the product comparison feature
	public $comparison_products = array();

	// Fields to display for product comparison
	public $product_comparison_fields;

	// Products that are currently in the inquiry cart
	...
	// Stores the number of pages of products there are for display
	public $max_pages = 1;

	// Used to display a single product
